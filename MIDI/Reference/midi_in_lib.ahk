...
{
	global
	if ((midi_in_hModule := DllCall("LoadLibrary", Str,A_ScriptDir . "C:\Users\humerous\Desktop\AutoHotKey\MIDI\midi_in.dll")) == 0)
	{ 
		MsgBox Get fucked, cannot load library midi_in.dll
		return 1
	}
